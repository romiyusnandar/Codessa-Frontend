...
export function Sidebar() {
  ...
  return (
    <nav className="flex shrink-0 gap-1 overflow-x-auto border-b border-line bg-white px-3 py-2 md:h-[calc(100vh-6.5rem)] md:w-56 md:flex-col md:gap-0.5 md:overflow-visible md:border-b-0 md:border-r md:px-3 md:py-5">
      {navItems.map((item) => {
